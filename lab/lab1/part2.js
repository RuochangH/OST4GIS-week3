...
var isEven = function(num) {if(num%2==0){ return true;} else{return false;} };
...
var not = function(tf) {if(tf==true) {return false;} else {return true;} };
...
var filterOutLessThan10 = function(list) {var newlist = [];
...
var filter = function(array, func) {var newarray = [];
